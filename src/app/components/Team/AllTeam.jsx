...
// Team data structured by team section
const teamSections = [
  {
    title: "Core Team",
    members: [
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        description:
          "Ensuring software quality with rigorous testing processes.",
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        role: "Senior Engineer, Offensive Security",
        description:
      ...
      <section className="md:container px-4 py-16">
        ...
        {teamSections.map((section, sectionIndex) => (
          <div key={sectionIndex} className="mb-16">
            ...
            {/* Horizontal Rule */}
            {sectionIndex < teamSections.length - 1 && (
